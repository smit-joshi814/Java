/*Computer Graphics P16: Write a Graphic program for Point Clipping Algorithm.
 */
...
public class P16PointClipMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblWinMin, lblWinMax;
    TextField tfx, tfy, tfxwmn, tfywmn, tfxwmx, tfywmx; 
    Button btnDraw, btnClip;
    Panel p1;
    P16PointClipCanvas can = new P16PointClipCanvas();
    
    public P16PointClipMain(){
