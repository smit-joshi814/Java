...
public class P17CohSuthLineClipMain extends Frame implements ActionListener{
    
    Label lblXYCoord, lblWinMin, lblWinMax;
    TextField tfx, tfy, tfxwmn, tfywmn, tfxwmx, tfywmx; 
    Button btnDraw, btnClip;
    Panel p1;
    P17CohSuthLineClipCanvas can = new P17CohSuthLineClipCanvas();
    
    public P17CohSuthLineClipMain(){
